...
class Listing(Base):
    ...
    verified_at: Mapped[sa.DateTime | None] = mapped_column(sa.TIMESTAMP(timezone=True))
    ...
    featured_until: Mapped[sa.DateTime | None] = mapped_column(sa.TIMESTAMP(timezone=True))
